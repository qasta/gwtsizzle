package org.sgx.gwtsizzle.client.jsutil;
...
public class JsUtil {
	...
	//
	/**
	 * builds a javascript native object using indexes 0, 2, 4, 6 as keys and 1, 3, 5, 7 as values. Only values of native types are allowed - string, int, double, boolean.
	 * 
	 * @param ja
	 * @return
	 */
	...
	public static final native <T> Collection<T> toJavaCollection(JavaScriptObject array)/*-{
		return @org.sgx.gwtsizzle.client.jsutil.JsArrayCollection::create(Lcom/google/gwt/core/client/JavaScriptObject;)(array);
	}-*/;
